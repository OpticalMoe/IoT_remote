...
#define EAP_IDENTITY "xxx@usst.edu.cn" //nickname@example.com, at some organizations should work nickname only without realm, but it is not recommended
#define EAP_PASSWORD "xxx" //password for eduroam account
